...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String CUSTOMSETTINGS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, CUSTOMSETTINGS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, CUSTOMSETTINGS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(CUSTOMSETTINGS, "interval");
            if(newInterval != null)
